            ...
            <ul class="nav navbar-top-links navbar-right">
			 ...
			 ?>
                ...
                <li class="dropdown">
					...
					<i>Xin chào: <?php echo $user_username = $user_row['firstname']." ".$user_row['lastname'];?></i>
                    </a>
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="candidate.php"><i class = "fa fa-user fa-fw"></i> Hiển thị các ứng viên</a>
                         
                        </li>
						<li>
                          <a href="voters.php"><i class = "fa fa-user fa-fw"></i> Hiển thị người bình chọn</a>
                        </li>
                        <li>
                          <a href="current_students.php"><i class = "fa fa-user fa-fw"></i>Quản trị tài khoản</a>
                        </li>
						
                        <li>
                            <a href="canvassing.php"><i class="fa fa-download fa-fw"></i>Báo cáo bình chọn<nav></nav></a>
                        </li>
                        <li>
