    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<a href="voted.php" class = "btn btn-success btn-outline"> Đã bình chọn(<?php echo $count1['total']?>)</a>
				<a href="unvoted.php" class = "btn btn-danger btn-outline">Chưa bình chọn(<?php echo $count2['total']?>) </a><p><br clear = all><p/>
